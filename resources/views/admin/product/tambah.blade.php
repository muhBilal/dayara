								...
								<div class="flex">
									<div class="w-3/4">
										...
										<div class="form-group">
											...
											<input required type="number" class="form-control" name="panjang">
										</div>
										<div class="form-group">
											<label for="exampleInputUsername1">Lebar</label>
											<input required type="number" class="form-control" name="lebar">
										</div>
										<div class="form-group">
											<label for="exampleInputUsername1">Isi</label>
											<input required type="number" class="form-control" name="isi">
										</div>
										<div class="form-group">
