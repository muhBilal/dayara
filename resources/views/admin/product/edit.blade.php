                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('admin.product.update',['id' => $product->id]) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                <label for="exampleInputUsername1">Panjang</label>
                                <input required type="number" class="form-control" name="panjang" value="{{ $product->panjang}}">
                                </div>
                                <div class="form-group">
                                <label for="exampleInputUsername1">Lebar</label>
                                <input required type="number" class="form-control" name="lebar" value="{{ $product->lebar}}">
                                </div>
                                <div class="form-group">
                                <label for="exampleInputUsername1">Isi</label>
                                <input required type="number" class="form-control" name="isi" value="{{ $product->isi}}">
                                </div>
                                <div class="form-group">
