...
<html lang="en">
	<head>
		...
		<title>PT. Dayara Laut Sejahtera</title>
		<!-- plugins:css -->
	...
	<body>
		<div class="container-scroller">
			...
			<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row" style="background-color:#2EBABA">
				<div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center" style="background-color:#2EBABA">
					<a class="navbar-brand brand-logo"href="{{ url('admin') }}">
						<img src="{{ asset('adminassets') }}/assets/images/depan.png" alt="logo" width="50%" height="50%" style="width:60px;height:50px" />
					</a>
						...
						<li class="nav-item nav-profile dropdown">
							<a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
								<div class="nav-profile-img">
									<img src="{{ asset('adminassets') }}/assets/images/faces/face9.jpg" alt="image">
						...
						<li class="nav-item nav-profile">
							<a href="#" class="nav-link">
								<div class="nav-profile-image">
									<img src="{{ asset('adminassets') }}/assets/images/faces/face9.jpg" alt="profile">
						...
						<li class="nav-item ">
							...
							<div class="collapse" id="ui-basic1">
								<ul class="nav flex-column sub-menu">
									<li class="nav-item"> <a class="nav-link" href="{{ route('admin.fish') }}">Fish</a></li>
									<li class="nav-item"> <a class="nav-link" href="{{ route('admin.grade') }}">Grade Fish</a></li>
									<li class="nav-item"> <a class="nav-link" href="{{ route('admin.size') }}">Size Fish</a></li>
									<li class="nav-item"> <a class="nav-link" href="{{ route('admin.supplier') }}">Suplier</a></li>
									<li class="nav-item"> <a class="nav-link" href="{{ route('admin.warehouse') }}">Gudang</a></li>
									<li class="nav-item"> <a class="nav-link" href="{{ route('admin.rack') }}">Rack</a></li>
								</ul>
							</div>
						</li>
						@endif
				 ...
				 @yield('content')
					...
					<footer class="footer">
						<div class="d-sm-flex justify-content-center justify-content-sm-between">
							...
							<span class="text-muted float-sm-right d-block mt-1 mt-sm-0 text-center">Hand-crafted & made with <i class="mdi mdi-heart text-danger"></i></span>
						</div>
					</footer>
					<!-- partial -->
				</div>
